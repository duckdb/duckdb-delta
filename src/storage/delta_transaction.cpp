...
DeltaTableEntry &DeltaTransaction::InitializeTableEntry(ClientContext &context, DeltaSchemaEntry &schema_entry, idx_t version, optional_ptr<const DeltaMultiFileList> old_snapshot) {
	unique_lock<mutex> lck(lock);
